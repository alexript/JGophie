...
public class GopherPage {
     ...
     * tries to parse it as a gopher menu. If that fails, it will try to
     * evaluate the content type and store the source code.
     *
    ...
    /**
     * Returns the source code in base64 encoded format which can be used to
    ...
    /**
     * Saves the contents of this page to the defined file
     *
